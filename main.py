...
class Face_Recognition_System:
    def __init__(self, root):
        ...
        exi_b1 = Button(bg_img, command=self.exit, image=self.exi_img1, cursor="hand2", )
    ...
    def exit(self):
        self.exit = messagebox.askyesno(
            "Face Recognition", "Do you want to exit")
        if self.exit > 0:
            self.root.destroy()
        else:
            return
